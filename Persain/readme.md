...
می‌توانید با تبدیل شدن به حامی در **[GitHub Sponsors](https://github.com/sponsors/RibaldzZ)** یا از طریق [PayPal]() از این پروژه حمایت کنید.
...
اگر می‌خواهید به طور فعال در این چالش شرکت کنید، می‌توانید به گروه تلگرام [چالش 30DaysOfPython](https://t.me/+YourLinkHere) بپیوندید.
...
این چالش خوانا، به زبان انگلیسی محاوره‌ای نوشته شده، جذاب، انگیزه‌بخش و در عین حال بسیار پرچالش است. برای به پایان رساندن این چالش نیاز به تخصیص زمان زیادی دارید. اگر یادگیرنده بصری هستید، می‌توانید درس‌های ویدیویی را در کانال یوتیوب \<a href="https://www.youtube.com/@ribaldzz"\>RibaldzZ Channel\</a\> مشاهده کنید. می‌توانید از ویدیوی [پایتون برای مبتدیان مطلق](https://youtu.be/OCCWZheOesI) شروع کنید. کانال را سابسکرایب کنید، در ویدیوهای یوتیوب کامنت بگذارید و سوال بپرسید و فعال باشید، نویسنده در نهایت متوجه شما خواهد شد.
...
```py
('Mark', 'Pawel', 'Brook', 'Abraham', 'Lidiya') # نام‌ها
```
