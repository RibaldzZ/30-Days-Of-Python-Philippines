...
Якщо ви бажаєте активно долучитися до випробуванні, ви можете приєднатися до групи у Telegram [30DaysOfPython challenge](https://t.me/+YourLinkHere).  
...
```py
('Mark', 'Pawel', 'Brook', 'Abraham', 'Lidiya') # Імена
```
...
print(type('Mark'))  # String (рядок)
print(type([1, 2, 3]))   # List (список)
print(type({'name':'Mark'})) # Dictionary (словник)
