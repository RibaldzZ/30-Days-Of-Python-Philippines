...
print(sentence) # I am Mark Anthony Ribaldo. I am a teacher. I live in Finland.
...
```py
 lst = ['Mark', 250, True, {'country':'Philippines', 'city':'Helsinki'}] # list containing different data types
```
...
29. Find the middle country(ies) in the [countries list](https://github.com/RibaldzZ/30-Days-Of-Python-Philippines/tree/master/data/countries.py)
...
[<< Part 1](https://github.com/RibaldzZ/30-Days-Of-Python-Philippines/blob/master/readme.md) | [Part 3>>](https://github.com/RibaldzZ/30-Days-Of-Python-Philippines/blob/master/readme7-9.md)